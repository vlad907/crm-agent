...
class WebsitePage(Base):
    ...
    extracted_emails: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
    extracted_phones: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
